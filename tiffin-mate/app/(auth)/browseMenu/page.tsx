...
export default function BrowsePage() {
  return (
    <div className="min-h-screen bg-[#f7f6ef] text-neutral-900 font-sans flex items-center justify-center p-6">
      <div className="max-w-2xl w-full p-8 bg-white rounded-2xl shadow">
        ...
        <div className="mt-6">
          <Link href="/dashboard" className="text-emerald-600 hover:underline">Back to Home</Link>
        </div>
      </div>
    </div>
  );
